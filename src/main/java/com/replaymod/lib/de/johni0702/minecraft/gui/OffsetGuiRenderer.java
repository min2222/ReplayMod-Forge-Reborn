...
public class OffsetGuiRenderer implements GuiRenderer {
	...
	public void drawTexturedRect(int x, int y, int u, int v, int width, int height, int uWidth, int vHeight,
		...
		this.renderer.drawTexturedRect(x + this.position.getX(), y + this.position.getY(), u, v, width, height, uWidth,
				vHeight, textureWidth, textureHeight);
	}
	...
	public void drawRect(int x, int y, int width, int height, int topLeftColor, int topRightColor, int bottomLeftColor,
		...
		this.renderer.drawRect(x + this.position.getX(), y + this.position.getY(), width, height, topLeftColor,
				topRightColor, bottomLeftColor, bottomRightColor);
	}

	public void drawRect(int x, int y, int width, int height, ReadableColor topLeftColor, ReadableColor topRightColor,
	...
	public int drawString(int x, int y, int color, String text) {
		return this.renderer.drawString(x + this.position.getX(), y + this.position.getY(), color, text)
				- this.position.getX();
	}
	...
	public int drawCenteredString(int x, int y, int color, String text) {
		return this.renderer.drawCenteredString(x + this.position.getX(), y + this.position.getY(), color, text)
				- this.position.getX();
	}
	...
	public int drawString(int x, int y, int color, String text, boolean shadow) {
		return this.renderer.drawString(x + this.position.getX(), y + this.position.getY(), color, text, shadow)
				- this.position.getX();
	}
	...
	public int drawCenteredString(int x, int y, int color, String text, boolean shadow) {
		return this.renderer.drawCenteredString(x + this.position.getX(), y + this.position.getY(), color, text, shadow)
				- this.position.getX();
	}
